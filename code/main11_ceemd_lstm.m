...
save predicted_result/ceemd_lstm predict_value true_value

%%
load predicted_result/ceemd_lstm
...
% tempdata=(true_value-predict_value).^2;
% tempdata2=(true_value-mean(true_value)).^2;
